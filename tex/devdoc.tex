...
\begin{itemize}
    \item Faster filtering process, since the internal vectors used to
        represent the graph are not touched.
    \item Uses more memory, since memory used by unused data are not freed back
        to the operating system.
    \item Not currently implemented, but these unused parts of the graph can be
        given to the advanced users, if they're interested.
    \item In boost's graph implementation, \lstinline|vertex_descriptor|
